      ...
      typography: ({ theme }: { theme: any }) => ({
        DEFAULT: {
          css: {
            ...
            '--tw-prose-bullets': theme('colors.muted.DEFAULT / 1'),
            ...
            '--tw-prose-invert-pre-code': theme('colors.secondary.foreground / 1'),
            '--tw-prose-invert-pre-bg': theme('colors.secondary.DEFAULT / 1'),
